...
fn setup(mut input_map: ResMut<InputMap>) {
    input_map
        ...
        .bind_gamepad_button_pressed_for_player(0, GamepadButtonType::Start, "QUIT_APP_PLYR1")
        .bind_gamepad_button_pressed_for_player(0,GamepadButtonType::South, "SHOOT_PLYR1")
        .bind_gamepad_button_pressed_for_player(0,GamepadButtonType::RightTrigger2, "SHOOT_PLYR1")
        .bind_gamepad_axis_for_player(0,
        ...
        .bind_gamepad_button_pressed_for_player(1, GamepadButtonType::Start, "QUIT_APP_PLYR2")
        .bind_gamepad_button_pressed_for_player(1,GamepadButtonType::South, "SHOOT_PLYR2")
        .bind_gamepad_button_pressed_for_player(1,GamepadButtonType::RightTrigger2, "SHOOT_PLYR2")
        .bind_gamepad_axis_for_player(1,
            GamepadAxis::RightStickXNegative,
            "AIM_LEFT_PLYR2",
        )
        .bind_gamepad_axis_for_player(1,
        ...
        .bind_gamepad_button_pressed_for_player(2, GamepadButtonType::Start, "QUIT_APP_PLYR3")
        .bind_gamepad_button_pressed_for_player(2,GamepadButtonType::South, "SHOOT_PLYR3")
        .bind_gamepad_button_pressed_for_player(2,GamepadButtonType::RightTrigger2, "SHOOT_PLYR3")
        .bind_gamepad_axis_for_player(2,
            GamepadAxis::RightStickXNegative,
            "AIM_LEFT_PLYR3",
        )
        .bind_gamepad_axis_for_player(2,
        ...
        .bind_gamepad_button_pressed_for_player(3, GamepadButtonType::Start, "QUIT_APP_PLYR4")
        .bind_gamepad_button_pressed_for_player(3,GamepadButtonType::South, "SHOOT_PLYR4")
        .bind_gamepad_button_pressed_for_player(3,GamepadButtonType::RightTrigger2, "SHOOT_PLYR4")
        .bind_gamepad_axis_for_player(3,
            GamepadAxis::RightStickXNegative,
            "AIM_LEFT_PLYR4",
        )
        .bind_gamepad_axis_for_player(3,
